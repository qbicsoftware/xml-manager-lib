...
public class NewXMLParser {
  ...
  public JAXBElement<Qexperiment> createNewDesign(List<String> omicsTypes,
      ...
      Map<String, List<Property>> otherProps) throws JAXBException {
  ...
  public JAXBElement<life.qbic.xml.study.Qexperiment> parseXMLString(String xml)
      throws JAXBException {
    if (xml == null || xml.isEmpty())
      return null;
    JAXBContext jc = JAXBContext.newInstance("life.qbic.xml.study");
    Unmarshaller unmarshaller = jc.createUnmarshaller();
    JAXBElement<Qexperiment> root =
        unmarshaller.unmarshal(new StreamSource(new StringReader(xml)), Qexperiment.class);
    return root;
  }
  ...
  public JAXBElement<life.qbic.xml.study.Qexperiment> getEmptyXML() throws JAXBException {
    JAXBContext jc = JAXBContext.newInstance("life.qbic.xml.study");
    Unmarshaller unmarshaller = jc.createUnmarshaller();
    JAXBElement<Qexperiment> root = unmarshaller.unmarshal(new StreamSource(new StringReader(
        "<?life.qbic.xml.study version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"
